...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/prime-factorization-tree.git
   cd prime-factorization-tree
   ```
...
[![Repo](https://img.shields.io/badge/prime-factorization-tree-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/prime-factorization-tree)
